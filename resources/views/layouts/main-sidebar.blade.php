			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('invoices.invoices')}}">قائمة الفواتير</a></li>
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}"> الفواتير الغير مدفوعه جزئيا</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('sections.sections') }}">الاقسام</a></li>
							<li><a class="slide-item" href="{{route('Products.Products') }}">المنتجات</a></li>
						</ul>
					</li>
				</ul>
			</div>
